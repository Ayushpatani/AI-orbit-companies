    ...
    <header className="orbit-topbar">
      <div className="orbit-topbar-inner">
        ...
        <nav className="orbit-top-links" aria-label="AI Orbit navigation">
          <a href="https://aiorbit.club/tools?category=business">Business AI</a>
          <a href="https://aiorbit.club/leaderboard">Leaderboard</a>
          <a href="https://aiorbit.club/tools">Resources</a>
          <a href="https://aiorbit.club/#newsletter">Newsletter</a>
        </nav>
